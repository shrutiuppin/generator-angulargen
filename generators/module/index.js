...
module.exports = yeoman.generators.Base.extend({
    ...
    welcome: function () {
        this.log(yosay(
            'Welcome to the ' + chalk.red('generator-angulargen') + ' generator!'
        ));
        this.log(yosay(
    ...
    writingModule: function () {
        ...
        this.fs.copy(
            ...
            this.destinationPath(path.join(this.modulePath, this.modulename, 'constants.js'))
        );
        this.fs.copy(
            this.templatePath('../../templates/values.js'),
            this.destinationPath(path.join(this.modulePath, this.modulename, 'values.js'))
        );
        this.fs.copyTpl(
